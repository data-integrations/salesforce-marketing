...
public class DataExtensionInfoTest {
  ...
  public static final List<ETDataExtensionColumn> TEST_COLUMNLIST = new ArrayList<>();
  public static final Map<String, ETDataExtensionColumn> COLUMNS = new HashMap<>();
  ...
  public void testGetColumn() {
    ...
    Assert.assertFalse(info.getColumn("name").getKey().isEmpty());
